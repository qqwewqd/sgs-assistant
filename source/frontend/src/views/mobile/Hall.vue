  ...
  <main class="page">
    <div class="mobile-shell">
      ...
      <section v-if="!game.room" class="panel action-panel">
        <button class="big-action" @click="create">创建新房间</button>
        <div class="join-box">
      ...
      <section v-else class="panel room-panel">
        ...
        <div class="toolbar room-actions">
          <button class="warm-button" :disabled="!game.room.canStart" @click="start">开始发牌</button>
...
import { createRoom, getRoom, joinRoom, leaveRoom, startGame } from '../../api/room'
...
const startHint = computed(() => {
  if (!game.room || game.room.canStart || !game.room.owner) return ''
